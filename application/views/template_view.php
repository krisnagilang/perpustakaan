...
<head>
    ...
    <!-- Bootstrap -->
    <link href="assets/ico/angkasa.ico" rel="shortcut icon">
...
<body class="nav-md">
    <div class="container body">
        <div class="main_container">
            <div class="col-md-3 left_col menu_fixed">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="#" class="site_title"><img src="<?= base_url('assets/ico/angkasa.ico'); ?>"></img> <span>Perpustakaan</span></a>
                    </div>
                    <hr>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li>
                                    <a href="<?php echo base_url() ?>anggota"><i class="fa fa-users"></i> Data Anggota</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url() ?>buku"><i class="fa fa-book"></i> Data Buku</a>
                                </li>
                                <?php if ($this->session->userdata('role') == 'superadmin') : ?>
                                    <li>
                                        <a href="<?php echo base_url() ?>petugas"><i class="fa fa-user"></i> Data Petugas</a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </div>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <img src="<?php echo base_url() ?>assets/images/upload/profile/<?= $this->db->where('USERNAME', $this->session->userdata('username'))->get('admin')->row('PHOTO'); ?>" alt=""><?php echo $this->session->userdata('username'); ?>
            ...
            <footer>
                <div class="text-center">
                    &copy <?= date('Y'); ?> Perpustakaan SMK Angkasa 1 Margahayu
                </div>
                <div class="clearfix"></div>
            </footer>
            <!-- /footer content -->
