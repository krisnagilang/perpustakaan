                ...
                <div class="x_content">
                    <div class="row">
                        ...
                        <form method="post" action="<?php echo base_url() ?>anggota/submit" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-cs-12" for="first-name">Kelas
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-cs-12" for="first-name">Jurusan
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="telp" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            <div class="form-group">
