                            ...
                            <tbody>
                                ...
                                <?php foreach ($datas as $yuhu) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php $tgl = date_create($yuhu->TGL_PENGEMBALIAN);
                                            echo date_format($tgl, "D, d M Y"); ?>
                                        </td>
                                        <td><?php echo $yuhu->JML_BUKU ?></td>
                                        <td>
                                            <a class="btn btn-info btn-xs detaila" id="<?php echo $yuhu->ID_PINJAM ?>"><i class="fa fa-list-alt"></i> Detail Pengembalian</a>
                                        </td>
                                    </tr>
                                    <?php $no++; ?>
                                <?php endforeach; ?>
